...
SIGNAL \wada|decOut_n~0_combout\ : std_logic;
SIGNAL \wada|decOut_n~1_combout\ : std_logic;
SIGNAL \wada|decOut_n~2_combout\ : std_logic;
SIGNAL \wada|decOut_n~3_combout\ : std_logic;
SIGNAL \wada|decOut_n~4_combout\ : std_logic;
SIGNAL \wada|decOut_n~5_combout\ : std_logic;
SIGNAL \wada|decOut_n~6_combout\ : std_logic;
...
-- Equation(s):
-- \inst|s_count~9_combout\ = (!\inst|s_count\(0) & !\KEY[1]~input_o\)
...
\wada|decOut_n~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \wada|decOut_n~0_combout\ = (\inst|s_count\(0) & (!\inst|s_count\(3) & (\inst|s_count\(2) $ (!\inst|s_count\(1))))) # (!\inst|s_count\(0) & (!\inst|s_count\(1) & (\inst|s_count\(2) $ (!\inst|s_count\(3)))))
...
PORT MAP (
	...
	datad => \inst|s_count\(3),
	combout => \wada|decOut_n~0_combout\);

-- Location: LCCOMB_X114_Y51_N16
\wada|decOut_n~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \wada|decOut_n~1_combout\ = (\inst|s_count\(0) & (\inst|s_count\(3) $ (((\inst|s_count\(1)) # (!\inst|s_count\(2)))))) # (!\inst|s_count\(0) & (!\inst|s_count\(2) & (\inst|s_count\(1) & !\inst|s_count\(3))))
...
PORT MAP (
	...
	datac => \inst|s_count\(1),
	datad => \inst|s_count\(3),
	combout => \wada|decOut_n~1_combout\);

-- Location: LCCOMB_X114_Y51_N14
\wada|decOut_n~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \wada|decOut_n~2_combout\ = (\inst|s_count\(1) & (\inst|s_count\(0) & ((!\inst|s_count\(3))))) # (!\inst|s_count\(1) & ((\inst|s_count\(2) & ((!\inst|s_count\(3)))) # (!\inst|s_count\(2) & (\inst|s_count\(0)))))
...
PORT MAP (
	...
	datac => \inst|s_count\(1),
	datad => \inst|s_count\(3),
	combout => \wada|decOut_n~2_combout\);

-- Location: LCCOMB_X114_Y51_N4
\wada|decOut_n~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \wada|decOut_n~3_combout\ = (\inst|s_count\(1) & ((\inst|s_count\(0) & (\inst|s_count\(2))) # (!\inst|s_count\(0) & (!\inst|s_count\(2) & \inst|s_count\(3))))) # (!\inst|s_count\(1) & (!\inst|s_count\(3) & (\inst|s_count\(0) $ (\inst|s_count\(2)))))
...
PORT MAP (
	...
	datac => \inst|s_count\(1),
	datad => \inst|s_count\(3),
	combout => \wada|decOut_n~3_combout\);

-- Location: LCCOMB_X114_Y51_N30
\wada|decOut_n~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \wada|decOut_n~4_combout\ = (\inst|s_count\(2) & (\inst|s_count\(3) & ((\inst|s_count\(1)) # (!\inst|s_count\(0))))) # (!\inst|s_count\(2) & (!\inst|s_count\(0) & (\inst|s_count\(1) & !\inst|s_count\(3))))
...
PORT MAP (
	...
	datac => \inst|s_count\(1),
	datad => \inst|s_count\(3),
	combout => \wada|decOut_n~4_combout\);

-- Location: LCCOMB_X114_Y51_N8
\wada|decOut_n~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \wada|decOut_n~5_combout\ = (\inst|s_count\(1) & ((\inst|s_count\(0) & ((\inst|s_count\(3)))) # (!\inst|s_count\(0) & (\inst|s_count\(2))))) # (!\inst|s_count\(1) & (\inst|s_count\(2) & (\inst|s_count\(0) $ (\inst|s_count\(3)))))
...
PORT MAP (
	...
	datac => \inst|s_count\(1),
	datad => \inst|s_count\(3),
	combout => \wada|decOut_n~5_combout\);

-- Location: LCCOMB_X114_Y51_N18
\wada|decOut_n~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \wada|decOut_n~6_combout\ = (\inst|s_count\(2) & (!\inst|s_count\(1) & (\inst|s_count\(0) $ (!\inst|s_count\(3))))) # (!\inst|s_count\(2) & (\inst|s_count\(0) & (\inst|s_count\(1) $ (!\inst|s_count\(3)))))
...
PORT MAP (
	...
	datac => \inst|s_count\(1),
	datad => \inst|s_count\(3),
	combout => \wada|decOut_n~6_combout\);
