...
SIGNAL \inst|decOut_n[2]~10_combout\ : std_logic;
...
-- Equation(s):
-- \inst|decOut_n[6]~2_combout\ = (\SW[3]~input_o\ & (!\SW[0]~input_o\ & (!\SW[1]~input_o\ & \SW[2]~input_o\))) # (!\SW[3]~input_o\ & (\SW[2]~input_o\ $ (((!\SW[1]~input_o\) # (!\SW[0]~input_o\)))))
...
-- Equation(s):
-- \inst|decOut_n~6_combout\ = (\SW[0]~input_o\ & (\SW[3]~input_o\ $ (((\SW[1]~input_o\) # (!\SW[2]~input_o\)))))
...
-- Equation(s):
-- \inst|decOut_n[3]~5_combout\ = (\SW[1]~input_o\ & ((\SW[0]~input_o\ & ((\SW[2]~input_o\))) # (!\SW[0]~input_o\ & (\SW[3]~input_o\ & !\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & (!\SW[3]~input_o\ & (\SW[0]~input_o\ $ (\SW[2]~input_o\))))
...
\inst|decOut_n[2]~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|decOut_n[2]~10_combout\ = (\SW[3]~input_o\ & (\SW[2]~input_o\ & ((\SW[1]~input_o\) # (!\SW[0]~input_o\))))
...
PORT MAP (
	...
	datac => \SW[1]~input_o\,
	datad => \SW[2]~input_o\,
	combout => \inst|decOut_n[2]~10_combout\);

-- Location: LCCOMB_X107_Y72_N18
\inst|decOut_n[2]~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|decOut_n[2]~11_combout\ = (\inst|decOut_n[2]~10_combout\) # (!\KEY[0]~input_o\)
...
PORT MAP (
	datac => \KEY[0]~input_o\,
	datad => \inst|decOut_n[2]~10_combout\,
	combout => \inst|decOut_n[2]~11_combout\);

-- Location: LCCOMB_X107_Y72_N20
\inst|decOut_n~12\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|decOut_n~12_combout\ = (\SW[3]~input_o\ & ((\SW[0]~input_o\ & (\SW[1]~input_o\)) # (!\SW[0]~input_o\ & ((\SW[2]~input_o\))))) # (!\SW[3]~input_o\ & (\SW[2]~input_o\ & (\SW[0]~input_o\ $ (\SW[1]~input_o\))))
...
-- Equation(s):
-- \inst|decOut_n~14_combout\ = (\SW[3]~input_o\ & (\SW[0]~input_o\ & (\SW[1]~input_o\ $ (\SW[2]~input_o\)))) # (!\SW[3]~input_o\ & (!\SW[1]~input_o\ & (\SW[0]~input_o\ $ (\SW[2]~input_o\))))
